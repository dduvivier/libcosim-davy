 ...
 */
#ifndef LIBCOSIM_ALGORITHM_WATERFALL_FIXED_STEP_ALGORITHM_HPP
#define LIBCOSIM_ALGORITHM_WATERFALL_FIXED_STEP_ALGORITHM_HPP
 ...
 */
class waterfall_fixed_step_algorithm : public algorithm
{
public:
    /**
     *  Constructor.
     ...
     */
    explicit waterfall_fixed_step_algorithm(duration baseStepSize, std::optional<unsigned int> workerThreadCount = std::nullopt, std::optional<bool> waterfall_effect = false);

    ~waterfall_fixed_step_algorithm() noexcept;

    waterfall_fixed_step_algorithm(const waterfall_fixed_step_algorithm&) = delete;
    waterfall_fixed_step_algorithm& operator=(const waterfall_fixed_step_algorithm&) = delete;

    waterfall_fixed_step_algorithm(waterfall_fixed_step_algorithm&&) noexcept;
    waterfall_fixed_step_algorithm& operator=(waterfall_fixed_step_algorithm&&) noexcept;
