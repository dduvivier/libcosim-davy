 ...
 */
#include "cosim/algorithm/waterfall_fixed_step_algorithm.hpp"
...
class waterfall_fixed_step_algorithm::impl
{
protected:
...
class waterfall_fixed_step_algorithm::pool_impl : public waterfall_fixed_step_algorithm::impl
{
public:
    explicit pool_impl(duration baseStepSize, std::optional<unsigned int> workerThreadCount)
        : waterfall_fixed_step_algorithm::impl(baseStepSize)
        , pool_(std::min(workerThreadCount.value_or(max_threads_), max_threads_))
    { }
...
class waterfall_fixed_step_algorithm::waterfall_impl : public waterfall_fixed_step_algorithm::impl
{
public:
...
waterfall_fixed_step_algorithm::waterfall_fixed_step_algorithm(duration baseStepSize, std::optional<unsigned int> workerThreadCount, std::optional<bool> waterfall_effect)
{
...
waterfall_fixed_step_algorithm::~waterfall_fixed_step_algorithm() noexcept = default;


waterfall_fixed_step_algorithm::waterfall_fixed_step_algorithm(waterfall_fixed_step_algorithm&& other) noexcept
    : pimpl_(std::move(other.pimpl_))
{
}


waterfall_fixed_step_algorithm& waterfall_fixed_step_algorithm::operator=(
    waterfall_fixed_step_algorithm&& other) noexcept
{
    pimpl_ = std::move(other.pimpl_);
    return *this;
}
...
void waterfall_fixed_step_algorithm::add_simulator(
    simulator_index i,
    simulator* s,
...
void waterfall_fixed_step_algorithm::remove_simulator(simulator_index i)
{
    pimpl_->remove_simulator(i);
}


void waterfall_fixed_step_algorithm::add_function(function_index i, function* f)
{
    pimpl_->add_function(i, f);
}

void waterfall_fixed_step_algorithm::connect_variables(variable_id output, variable_id input)
{
    pimpl_->connect_variables(output, input);
}

void waterfall_fixed_step_algorithm::connect_variables(variable_id output, function_io_id input)
{
    pimpl_->connect_variables(output, input);
}

void waterfall_fixed_step_algorithm::connect_variables(function_io_id output, variable_id input)
{
    pimpl_->connect_variables(output, input);
}

void waterfall_fixed_step_algorithm::disconnect_variable(variable_id input)
{
    pimpl_->disconnect_variable(input);
}

void waterfall_fixed_step_algorithm::disconnect_variable(function_io_id input)
{
    pimpl_->disconnect_variable(input);
}


void waterfall_fixed_step_algorithm::setup(
...
void waterfall_fixed_step_algorithm::initialize()
{
    pimpl_->initialize();
}


std::pair<duration, std::unordered_set<simulator_index>> waterfall_fixed_step_algorithm::do_step(
    time_point currentT)
{
    return pimpl_->do_step(currentT);
}

void waterfall_fixed_step_algorithm::set_stepsize_decimation_factor(cosim::simulator_index simulator, int factor)
{
